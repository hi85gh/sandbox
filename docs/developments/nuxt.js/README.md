...
- configurations: <https://github.com/hi85gh/sandbox/tree/main/src/nuxt.js/examples/configurations>
- nuxt-client-init-plugin: <https://github.com/hi85gh/sandbox/tree/main/src/nuxt.js/examples/nuxt-client-init-plugin>
